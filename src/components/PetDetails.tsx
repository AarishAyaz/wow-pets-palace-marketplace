        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <Heart
                className={`w-5 h-5 ${
                  isFavorite ? 'fill-destructive text-destructive' : 'text-primary'
                }`}
              />
            </Button>
            <Button
          ...
          <div className="space-y-6">
            ...
            <Card className="rounded-3xl border-0 shadow-lg">
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  {pet.microchipId && (
                    <div>
                      <p className="text-sm text-muted-foreground mb-1">Chip ID</p>
            ...
            {pet.status === 'adoption' && pet.adoptionStatus && (
              <Card className="rounded-3xl border-0 shadow-lg bg-gradient-to-r from-green-50 to-blue-50">
                <CardHeader>
                  <CardTitle className="text-foreground">Adoption Information</CardTitle>
                </CardHeader>
                <CardContent className="space-y-3">
                  ...
                  {pet.adoptionSource && (
                    <div className="flex items-center justify-between">
                      <span className="text-muted-foreground">Rescue Center</span>
                      <span className="text-foreground">{pet.adoptionSource}</span>
                    </div>
                  )}
                </CardContent>
              </Card>
            ...
            {pet.status === 'sale' && pet.price && (
              <Card className="rounded-3xl border-0 shadow-lg bg-gradient-to-r from-secondary/10 to-secondary/5">
                <CardHeader>
                  <CardTitle className="text-foreground">Sale Information</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="flex items-center justify-between">
            ...
            {similarPets.map((similarPet) => (
              ...
              >
                ...
                <CardContent className="p-6 space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">{similarPet.age}</p>
                </CardContent>
              </Card>
            ))}
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {relatedArticles.map((article) => (
              ...
              >
                ...
                <CardContent className="p-6 space-y-2">
                  <h3 className="text-foreground line-clamp-2">{article.title}</h3>
